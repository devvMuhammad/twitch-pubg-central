    ...
    <section id="streams" className="py-20 bg-gaming-darker">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-twitch to-twitch-light">
              Live Now
            </h2>
          ...
          <Button className="mt-4 md:mt-0 bg-twitch hover:bg-twitch-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {streamers.map((streamer, index) => (
            <div key={index} className="group relative overflow-hidden rounded-xl bg-gaming-light border border-twitch/20 transition-all hover:border-twitch/40 hover:shadow-lg hover:shadow-twitch/10">
              ...
              <div className="p-4">
                <div className="flex items-center mb-2">
                  <div className="w-8 h-8 rounded-full bg-twitch flex items-center justify-center mr-2">
                ...
                <Button variant="ghost" className="w-full mt-2 border border-twitch/20 hover:bg-twitch/10 text-white">
                  Watch Stream
                </Button>
              </div>
            </div>
